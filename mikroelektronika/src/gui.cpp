...
{ 
    ...
    makeLabel(*usersLayout, "Users", "usersLabel", this->window); //This way we have all widgets in one Vector, but graphically they're
    ...
    makeButton(*controlButtonsLayout, "New", "newUserPushButton", this->window);
    makeButton(*controlButtonsLayout, "Delete", "deleteUserPushButton",this->window);
    ...
    makeLabel(*userDetailsLayout, "User Details: ", "userDetailsLabel", this->window);
